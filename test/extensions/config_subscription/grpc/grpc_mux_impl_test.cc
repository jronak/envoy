...
public:
  ...
  void expectSendMessage(const std::string& type_url,
    ...
    EXPECT_CALL(async_stream ? *async_stream : async_stream_,
...
TEST_P(GrpcMuxImplTest, XdstpWithContextParams) {
  setup();
  InSequence s;
...
TEST_P(GrpcMuxImplTest, ReconnectionResetsNonceAndAcks) {
...
TEST_P(GrpcMuxImplTest, UnwatchedTypeRejectsResources) {
  setup();
